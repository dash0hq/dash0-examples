...
# Main script to run the complete Istio demo
set -e
...
echo "╔═══════════════════════════════════════════════════════════╗"
echo "║                                                           ║"
echo "║            Istio + OpenTelemetry + Dash0                 ║"
echo "║                     Demo Setup                            ║"
echo "║                                                           ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
"${SCRIPT_DIR}/scripts/02_build_nodejs_app.sh"
echo ""

"${SCRIPT_DIR}/scripts/03_install_observability_stack.sh"
echo ""

"${SCRIPT_DIR}/scripts/04_install_otel.sh"
echo ""

"${SCRIPT_DIR}/scripts/05_install_istio.sh"
echo ""

"${SCRIPT_DIR}/scripts/06_deploy_apps.sh"
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Port-forward to ingress gateway:"
...
echo ""
echo "     Or run the comprehensive test script:"
echo "     ./scripts/test_otel_features.sh"
echo ""
echo "  3. View telemetry:"
echo ""
echo "     ${YELLOW}Dash0 (primary):${NC}"
echo "     - Metrics: istio_* and envoy_* metrics"
echo "     - Traces: Distributed traces from Istio"
