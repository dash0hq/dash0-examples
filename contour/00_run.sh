...
echo "4. Install Contour with OpenTelemetry support"
...
echo -e "${BLUE}4/5: Installing Contour...${NC}"
...
echo "   - Metrics: Contour controller and Envoy proxy metrics"
echo "   - Traces: Distributed traces from Contour"
