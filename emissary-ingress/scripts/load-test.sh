...
# Simple load generation script for Emissary-ingress demo
set -e
...
echo -e "${GREEN}🚀 Starting load test for Emissary-ingress demo${NC}"
echo "================================="
...
echo ""
echo "Generated traffic for 60 seconds with:"
echo "  - 300 successful requests to /"
echo "  - 6 error requests to /notfound"
echo ""
echo "Check Dash0 for traces, logs, and metrics correlation!"